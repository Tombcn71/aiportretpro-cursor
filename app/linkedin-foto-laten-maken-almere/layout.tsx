...
export const metadata: Metadata = {
  ...
  description:
    "Professionele zakelijke profielfoto laten maken in Almere? Geen dure fotostudio nodig. Ontvang 40+ AI profielfoto's voor LinkedIn en CV binnen 15 minuten voor slechts €19.99.",
  keywords: [
    "LinkedIn profielfoto Almere",
    "Zakelijke foto Almere",
    "CV foto laten maken Almere",
