              ...
              {!showEmailForm ? (
                <>
                  ...
                  <Button
                    ...
                    disabled={loading}
                    variant="outline"
                    className="w-full border-2 border-blue-900 text-blue-900 hover:bg-blue-800 hover:text-white flex items-center justify-center space-x-3 py-6 text-lg font-semibold">
                    <MailPlus className="h-6 w-6" />
                    <span>
                      {isDirectLogin
                        ? "Inloggen met e-mail"
                        : "Registreer met e-mail"}
                    </span>
                  </Button>
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="w-full bg-blue-900 hover:bg-blue-800 text-white flex items-center justify-center space-x-3 py-6 text-lg font-semibold">
                ...
                <>
                  {/* GECORRIGEERD: Slechts één Google knop hier, niet genest */}
                  <Button
                    onClick={handleGoogleSignIn}
                    disabled={loading}
                    className="w-full bg-blue-900 hover:bg-blue-800 text-white flex items-center justify-center space-x-3 py-6 text-lg font-semibold mb-4">
                    <svg className="w-6 h-6" viewBox="0 0 24 24">
                      <path
                        fill="currentColor"
                        d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
