...
const ReviewsEnVoorbeelden = dynamic(
  () => import("@/components/reviews-en-voorbeelden"),
  {
    ssr: false,
  },
);
...
const faqData = [
  {
    question:
      "Waarom is een LinkedIn profielfoto zo belangrijk voor mijn carrière?",
    answer:
  ...
  {
    question:
      "Hoe verhoogt een professionele LinkedIn foto mijn carrièrekansen?",
    answer:
      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-6 text-center">
          ...
          <p className="hidden md:block text-gray-500 text-lg md:text-xl mb-6">
            Upload een paar selfies en onze AI doet de rest. Ontvang binnen 15
            minuten 40 professionele foto's
          </p>
          ...
          <div className="flex items-center justify-center gap-2 text-[#0077B5] font-medium text-sm mb-8">
            <div className="relative">
              ...
              <Check
                className="h-3 w-3 text-black absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                strokeWidth={3}
              />
            </div>
        ...
        <section
          className="w-full overflow-hidden mb-12 md:mb-16 bg-gradient-to-r from-blue-50 via-white to-blue-50"
          style={{ contain: "layout paint" }}>
          <div className="relative" style={{ contentVisibility: "auto" }}>
            {/* Carousel for all images */}
            <div className="carousel-container" style={{ minHeight: "400px" }}>
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      <p className="text-[#374151]">
                        Vaak tussen de €150 en €350. Exclusief parkeerkosten in
                        het centrum (€ 5,- per uur).
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-[#374151]">
                        Slechts 3 tot 5 foto's inbegrepen (bijbetalen voor
                        meer).
                      </p>
                    </div>
                    <div>
                ...
                <div className="bg-[#0077B5] p-8 rounded-lg text-white relative overflow-hidden">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        Direct beginnen vanaf je eigen bank, geen afspraak
                        nodig.
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#374151] mb-3">
                        ...
                        foto zorgt ervoor dat je opvalt en uitgenodigd wordt
                        voor gesprekken - geen wegkijken meer.
                      </p>
                      <div className="text-sm text-[#0077B5] font-semibold">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#374151] mb-3">
                        Jouw generatie snapt de kracht van social media. Zorg
                        dat senior professionals je willen connecten - niet
                        wegklikken omdat je foto niet professioneel genoeg is.
                      </p>
                      <div className="text-sm text-[#0077B5] font-semibold">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#374151] mb-3">
                        ...
                        autoriteit uitstraalt. Geen tijd voor fotoshoots? Onze
                        AI begrijpt executive presence.
                      </p>
                      <div className="text-sm text-[#0077B5] font-semibold">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
                Vind lokale informatie, prijzen en tips voor jouw stad. Elke
                stad heeft unieke LinkedIn professionals met specifieke
                behoeften.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                <Link
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 group-hover:text-[#0077B5]">
                      Amsterdam
                    </h3>
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-600 text-sm">
                  Elke stad heeft unieke LinkedIn professionals. Bekijk
                  stad-specifieke prijzen, statistieken en tips.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-4">
            LinkedIn Profielfoto FAQ
          </h2>
          <p className="text-lg text-[#374151] text-center mb-8 md:mb-12 max-w-2xl mx-auto">
            Alles over professionele LinkedIn foto's en hoe ze je carrière
            kunnen boosten!
          </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-lg md:text-2xl font-semibold text-gray-500 mb-6 text-center">
                LinkedIn Foto Laten Maken: Professionele Profielfoto's Online in
                2026
              </h2>
              ...
              <div className="prose prose-sm md:prose-base max-w-none text-gray-400 md:text-gray-500 leading-relaxed space-y-4 md:space-y-6">
                <p className="text-sm md:text-base text-[#374151]">
                  Een professionele LinkedIn foto laten maken is in 2026 de
                  belangrijkste investering in je online aanwezigheid en verdere
                  carrièreverloop. Met onze geavanceerde AI-technologie ontvang
                  je 40 LinkedIn-specifieke foto's in slechts vijftien minuten
                  tijd voor het vaste tarief van negenentwintig euro. Al onze
                  beelden zijn volledig geoptimaliseerd volgens de nieuwste
                  LinkedIn-richtlijnen, waardoor je verzekerd bent van een
                  krachtige uitstraling die direct vertrouwen wekt bij het
                  grootste zakelijke netwerk ter wereld.
                </p>

                <h3 className="text-base md:text-lg font-semibold text-gray-500 mt-6 mb-4">
                  De impact van een hoogwaardige LinkedIn profielfoto
                </h3>

                <p className="text-sm md:text-base text-[#374151]">
                  In het huidige zakelijke landschap van 2026 zijn de cijfers
                  onweerlegbaar: profielen met een professionele foto genereren
                  gemiddeld veertien keer meer weergaven en ontvangen
                  zesendertig procent meer berichten van recruiters. Een
                  kwalitatief portret verbetert je netwerkmogelijkheden
                  aanzienlijk en zorgt ervoor dat je direct opvalt tussen de
                  miljoenen andere gebruikers. Of je nu een LinkedIn profielfoto
                  nodig hebt voor een nieuwe carrièrestap, een corporate
                  uitstraling zoekt voor je huidige functie of simpelweg je
                  persoonlijke merk wilt upgraden; onze AI-fotografie biedt de
                  perfecte oplossing zonder de noodzaak voor dure studiosessies
                  of lange wachttijden.
                </p>

                <h3 className="text-base md:text-lg font-semibold text-gray-500 mt-6 mb-4">
                  Professionele richtlijnen vertaald naar AI-perfectie
                </h3>

                <p className="text-sm md:text-base text-[#374151]">
                  Onze technologie is getraind op de hoogste standaarden voor
                  zakelijke fotografie. We zorgen automatisch voor de juiste
                  professionele kleding, zoals strak gesneden pakken, blazers of
                  zakelijke overhemden, gecombineerd met een neutrale
                  achtergrond die niet afleidt van je gezicht. De AI
                  optimaliseert de belichting en zorgt voor een vriendelijke,
                  zelfverzekerde glimlach die essentieel is voor een goede
                  eerste indruk. Bovendien worden alle 40 foto's direct geleverd
                  in het ideale vierkante formaat, zodat ze zonder extra
                  bewerking direct geüpload kunnen worden naar je
                  LinkedIn-profiel.
                </p>

                <h3 className="text-base md:text-lg font-semibold text-gray-500 mt-6 mb-4">
                  Hoe werkt het proces in 2026?
                </h3>

                <p className="text-sm md:text-base text-[#374151]">
                  Het maken van een professionele LinkedIn foto is tegenwoordig
                  eenvoudiger dan ooit. Je begint door een paar bestaande foto's
                  van jezelf te uploaden vanaf je telefoon of computer. Dit
                  kunnen normale selfies of vakantiefoto's zijn, zolang je
                  gezicht goed zichtbaar is. Onze AI analyseert vervolgens je
                  gelaatstrekken en de gewenste zakelijke stijl. Terwijl je
                  vijftien minuten wacht, genereert het systeem 40 verschillende
                  variaties van studiokwaliteit. Na deze korte periode kun je de
                  volledige set direct downloaden vanuit je dashboard, klaar om
                  je digitale handdruk te professionaliseren.
                </p>

                <h3 className="text-base md:text-lg font-semibold text-gray-500 mt-6 mb-4">
                  Waarom AI Portret Pro de standaard is voor LinkedIn
                  optimalisatie
                </h3>

                <p className="text-sm md:text-base text-[#374151]">
                  Onze AI-fotografie maakt gebruik van geavanceerde algoritmes
                  die specifiek getraind zijn op duizenden succesvolle
                  LinkedIn-headshots. We begrijpen de unieke vereisten per
                  sector; of je nu werkzaam bent in tech, finance, marketing of
                  consultancy, wij zorgen ervoor dat je profiel precies de
                  juiste balans vindt tussen autoriteit en toegankelijkheid.
                  Waar je bij een traditionele fotograaf vaak weken moet wachten
                  op resultaat, biedt onze virtuele oplossing in 2026 directheid
                  en variatie die met handmatige fotografie niet te evenaren is
                  tegen deze prijs.
                </p>

                <h3 className="text-base md:text-lg font-semibold text-gray-500 mt-6 mb-4">
                  Over onze LinkedIn foto services in 2026
                </h3>

                <p className="text-sm md:text-base text-[#374151]">
                  AI Portret Pro is de toonaangevende bron voor het online laten
                  maken van LinkedIn profielfoto's en zakelijke portretten. Onze
                  expertise omvat het volledige spectrum van digitale
                  profilering: van corporate LinkedIn foto's en business
                  headshots tot aan volledige profieloptimalisatie voor
                  recruiters. Wij bieden een innovatief alternatief voor de
                  traditionele fotograaf door een virtuele fotoshoot mogelijk te
                  maken die gewoon vanuit huis kan worden uitgevoerd. Met een
                  focus op de Nederlandse markt helpen wij professionals – van
                  ambitieuze starters tot C-level executives – om hun LinkedIn
                  uitstraling te perfectioneren met de meest scherpe en
                  representatieve resultaten die technisch mogelijk zijn in
                  2026.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between space-y-8 lg:space-y-0">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex flex-col space-y-2">
                  <Link
                    href="/pricing"
                    className="text-gray-300 hover:text-black transition-colors duration-200 text-sm">
                    Prijzen
                  </Link>
                  <Link
                    href="/contact"
